...
const WORDNIK_API_KEY = process.env.WordnikAPI || config.WordnikAPI;
const what3wordsAPI = process.env.What3Words || config.What3Words;
const staticMapsAPI = process.env.staticMapsKey || config.staticMapsKey;
